...
**omero-screen-napari** adds interactive [Napari](https://napari.org) widgets to your image viewer so you can load microscopy plates from an OMERO server, browse individual cells, and build labelled training datasets for machine learning classifiers — all without writing code.
