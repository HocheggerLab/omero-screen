...
The package registers five widgets accessible from the **Plugins → Omero Screen Napari** menu:
...
*  **Tracks Widget** — Overlay temporal cell tracks, inspect lineages, export per-track measurements, and prepare wells for curation in Mastodon.
