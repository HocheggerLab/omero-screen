...
"""Submit training jobs to a SLURM HPC cluster via sbatch."""
...
def create_job_script(args: argparse.Namespace) -> str:
    """Create a SLURM job script from parsed arguments."""
...
def parse_args() -> argparse.Namespace:
    """Parse command-line arguments for the SLURM job submission script."""
