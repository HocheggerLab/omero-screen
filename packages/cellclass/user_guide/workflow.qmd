---
title: "Workflow (legacy notes)"
---

::: {.callout-note}
This page is the original developer walkthrough. It refers to the standalone
scripts (`run_training.py`, `batch_training.py`, `sbatch_training.py`,
`extract_model.py`, `test_model.py`), which are now subcommands of the unified
`cellclass` command — see the [CLI reference](../reference/cli/index.html).
:::
