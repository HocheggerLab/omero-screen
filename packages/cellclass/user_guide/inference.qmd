---
title: "Deploying Models for Inference"
---
...
See the [pipeline configuration](../../user-guide/installation.html#configure) for the full list of variables.
...
the [Setup Training Widget](../../napari/user-guide/training_widget.html). The
[Classifier Selector](../../napari/user-guide/session_manager.html) widget will load the
