---
title: "Normalised feature plots"
---
...
::: {.fig-card}
![Basic Normalized Plot](../assets/feature_norm_plot_basic.svg)
:::
...
::: {.fig-card}
![Triplicates with Blue Color Scheme](../assets/feature_norm_plot_triplicates.svg)
:::
...
::: {.fig-card}
![Grouped Layout with Purple Scheme](../assets/feature_norm_plot_grouped.svg)
:::
...
::: {.fig-card}
![Custom Threshold Analysis](../assets/feature_norm_plot_threshold.svg)
:::
...
::: {.fig-card}
![Combined Analysis Comparison](../assets/feature_norm_plot_comparison.svg)
:::
