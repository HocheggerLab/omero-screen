...
Count plots are the simplest type of analysis of the OmeroScreen IF data. They simply display the differences in cell count and provide a statistical analysis, if more than 3 repeats are available.
...
::: {.fig-card}
![Count Plot Example](../assets/qs_count_plot.svg)
:::
...
::: {.fig-card}
![Feature Plot Example](../assets/qs_feature_plot.svg)
:::
...
```
::: {.fig-card}
![Cell Cycle Plot Example](../assets/qs_cellcycle_plot.svg)
:::
...
- Explore [Plot Types](plot_types.qmd) for all available visualizations
- Learn about [Customization](customization.qmd) options
