#!/bin/bash -l
#SBATCH -J os3604.180524
#SBATCH -o os3604.180524."%j".out
#SBATCH -p gpu
...
if [ $code -ne 0 ]; then
  ...
  uv run python send-mail.py -m "Torch GPU unavailable for os3604.180524.sh" -s "os3604.180524.sh failed" hh65@sussex.ac.uk
  exit $code
fi
set -e
...
python send-mail.py -m '
          Job results: os3604.180524
          Plate: 3604
          ' -s 'Job results: os3604.180524' hh65@sussex.ac.uk
msg Done
rm os3604.180524.sh
